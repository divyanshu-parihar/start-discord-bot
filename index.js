...
(async () => {
  ...
  exec(
    "npm init -y && npm install @types/config @types/mongoose @types/node discord-api-types ts-node typescript --save-dev && npm install discord.js @discord.js/collections mongoose config" +
